...
<p>
    ...
    hemos creado otro objeto de esa isma clase, y haciendo un echo de esa propiedad en ese objeto de esa misma class_existsy podmeos comprobar que no salta un error, eso demuestra que es esa propiedad
